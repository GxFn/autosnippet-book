...
| 搜索引擎 | `search/` | SearchEngine | BM25 · 字段加权 · 语义 rerank |
...
SearchEngine.search(query, options)            ← Layer 5: Service
  │ 1. BM25 coarse ranking
  │ 2. FieldWeighted scoring
  │ 3. MultiSignal ranking (usage / guard / quality)
  │ 4. Semantic rerank (if AI available)
  ▼
